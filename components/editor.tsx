  ...
  return (
    <div className="  flex flex-col">
      ...
      >
        ...
        {!!image && (
          <div className="p-2">
            <div className="group/image relative flex size-20 items-center justify-center">
        ...
        <div className="border-t  z-[5] flex p-2 pb-2">
          <Hint label={isToolbarVisible ? 'Hide formatting' : 'Show formatting'}>
            <Button disabled={disabled}  variant="ghost" onClick={toggleToolbar}>
              <PiTextAa className="size-6" />
            </Button>
          </Hint>
          ...
          {variant === 'create' && (
            <Hint label="Image">
              <Button disabled={disabled} variant="ghost" onClick={() => imageElementRef.current?.click()}>
